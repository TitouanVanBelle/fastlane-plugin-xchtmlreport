...
require 'fastlane/plugin/xchtmlreport/version'

Gem::Specification.new do |spec|
  spec.name          = 'fastlane-plugin-xchtmlreport'
  spec.version       = Fastlane::Xchtmlreport::VERSION
  spec.author        = 'Titouan Van Belle'
